local diff = {
	["keyDiffs"] = {
		...
		["d1560pnilunilcdnilvdnilvpnilvunil"] = {
			["name"] = "Show Mission Resources Management window",
			["removed"] = {
				[1] = {
					["key"] = "'",
					["reformers"] = {
		...
		["d1636pnilunilcdnilvdnilvpnilvunil"] = {
			["name"] = "Control panel",
			["removed"] = {
				[1] = {
					["key"] = "Y",
		...
		["d333pnilunilcdnilvdnilvpnilvunil"] = {
			["name"] = "Normal keyboard turn speed",
			["removed"] = {
				[1] = {
					["key"] = "]",
					["reformers"] = {
		...
		["dnilp1688u1689cdnilvdnilvpnilvunil"] = {
			["name"] = "BDA show cursor",
			["removed"] = {
				[1] = {
					["key"] = "`",
					["reformers"] = {
